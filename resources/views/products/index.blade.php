...
<div class="container mt-4">
    ...
    <table class="table table-striped table-bordered">
        <thead class="table-dark">
            <tr>
                <th>
                    <a href="{{ route('products.index', ['sort' => 'name', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}" class="text-light text-decoration-none">
                        Name
                ...
                <th>
                    <a href="{{ route('products.index', ['sort' => 'price', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}" class="text-light text-decoration-none">
                        Price
        ...
        <tbody>
            @foreach ($products as $product)
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <a href="{{ route('products.show', $product) }}" class="btn btn-info btn-sm me-2">View</a>
